...
const Hero = () => {
  return (
    <div className="relative min-h-screen w-full flex flex-col lg:flex-row items-center justify-center overflow-hidden bg-[var(--background)] transition-colors duration-500 pt-4 lg:pt-20">
      ...
      <div className="relative z-10 w-full lg:w-[60%] px-6 lg:px-20 text-center lg:text-left" suppressHydrationWarning>
        <h2 className="mb-4 md:mb-6 animate-[hero-subtitle_1s_cubic-bezier(0.04,0.56,0.4,1)_0.2s_both]">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-serif text-[var(--foreground)] mb-6 md:mb-8 leading-[1.1] tracking-tight transition-colors duration-300 animate-[hero-title_1.2s_cubic-bezier(0.18,0.89,0.32,1.28)_0.5s_both]">
          Fragrance That <br /> <span className="font-normal italic">Suits you</span>
        </h1>
        <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-6 mt-4 md:mt-8 animate-[hero-cta_0.8s_cubic-bezier(0.68,-0.55,0.265,1.55)_0.8s_both]">
      ...
      <div className="relative w-full lg:w-[40%] h-[400px] lg:h-screen flex items-center justify-center px-6 pointer-events-none">
        <div className="relative w-full h-full max-w-md">
          {/* Main Large Image */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-56 h-72 sm:w-72 sm:h-[400px] z-20 rounded-2xl overflow-hidden shadow-2xl rotate-3 animate-[float-1_6s_ease-in-out_0s_infinite]">
            <Image
              src="/cluster-oud.png"
              alt="Luxury Oud"
              fill
          ...
          {/* Secondary Top Image */}
          <div className="absolute top-1/4 right-0 w-36 h-48 sm:w-48 sm:h-64 z-10 rounded-2xl overflow-hidden shadow-xl -rotate-6 animate-[float-2_5s_ease-in-out_0.5s_infinite]">
            <Image
          ...
          {/* Third Bottom Image */}
          <div className="absolute bottom-1/4 left-0 w-40 h-52 sm:w-52 sm:h-64 z-30 rounded-2xl overflow-hidden shadow-xl rotate-12 animate-[float-3_8s_ease-in-out_1s_infinite]">
            <Image
